...
-- 資料庫： `my_sql_db`
--
CREATE DATABASE IF NOT EXISTS `my_sql_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `my_sql_db`;

-- --------------------------------------------------------

--
-- 資料表結構 `my_sql_db_table`
--

CREATE TABLE `my_sql_db_table` (
  `id` int(8) NOT NULL,
  `username` varchar(40) NOT NULL,
  `lat` varchar(15) NOT NULL,
  `lon` varchar(15) NOT NULL,
  `whatime` varchar(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- 傾印資料表的資料 `my_sql_db_table`
--

INSERT INTO `my_sql_db_table` (`id`, `username`, `lat`, `lon`, `whatime`) VALUES
(1, 'TestUser0', '25.0222738', '121.465623', '20221230_1535'),
(2, 'John', '31.236', '99.2257', '20221230_1605');
...
--
-- 資料表索引 `my_sql_db_table`
--
ALTER TABLE `my_sql_db_table`
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `my_sql_db_table`
--
ALTER TABLE `my_sql_db_table`
...
('root', '[{\"db\":\"my_sql_db\",\"table\":\"my_sql_db_table\"}]');
...
('root', '2022-12-30 08:55:14', '{\"Console\\/Mode\":\"show\",\"lang\":\"zh_TW\",\"ThemeDefault\":\"bootstrap\"}');
